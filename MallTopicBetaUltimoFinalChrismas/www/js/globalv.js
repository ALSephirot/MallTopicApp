// global app variables
	...
	var GlovalAMalls;
	var GlovalALocales;
	var LazyLoadControl = 0;
	var CargarInfo = true;
	var Conectado = false;
	var AltaVelocidad = false;
	var TSocial;
	var IdTelefono = "";
	var IdUsuario = [];
	var LocalesBuscar;
	...
	function setStoresBuscar (pStoresBuscar) {
		StoresBuscar = pStoresBuscar;
	}

	function getStoresBuscar () {
		return StoresBuscar;
	}
	...
	function setIsFavorito (pIsFavorito) {
		IsFavorito = pIsFavorito;
	}
	function getIsFavorito() {
		return IsFavorito;
	}

	function setIsBuscar (pIsBuscar) {
		IsBuscar = pIsBuscar;
	}
	function getIsBuscar() {
		return IsBuscar;
	}

	function setLocalesBuscar (pLocalesBuscar) {
		LocalesBuscar = pLocalesBuscar;
	}

	function getLocalesBuscar () {
		return LocalesBuscar;
	}

	function setIdUsuario (pIdUsuario,red) {
		IdUsuario[red] = pIdUsuario;
	}

	function getIdUsuario (red) {
		return IdUsuario[red];
	}

	function setIdTelefono (pIdTelefono) {
	...
	function setAltaVelocidad (pAltaVelocidad) {
		AltaVelocidad = pAltaVelocidad;
	}

	function getAltaVelocidad() {
		return AltaVelocidad;
	}

	function setConectado(pConectado) {
	...
	function setCargarInfo (pCargarInfo) {
		CargarInfo = pCargarInfo;
	}

	function getCargarInfo() {
		return CargarInfo;
	}

	function setLLControl (pLazyLoadControl) {
		LazyLoadControl = pLazyLoadControl;
	}

	function getLLControl() {
		return LazyLoadControl;
	}

	function setGlovalALocales(PGlovalALocales) {
		GlovalALocales = PGlovalALocales;
	}

	function getGlovalALocales() {
		return GlovalALocales;
	}

	function setGlovalAMalls(PGlovalAMalls) {
		GlovalAMalls = PGlovalAMalls;
	}

	function getGlovalAMalls() {
		return GlovalAMalls;
	}
	...
	window.setGlovalAMalls = setGlovalAMalls;
	window.getGlovalAMalls = getGlovalAMalls;
	window.setLLControl = setLLControl;
	window.getLLControl = getLLControl;
	window.setGlovalALocales = setGlovalALocales;
	window.getGlovalALocales = getGlovalALocales;
	window.setCargarInfo = setCargarInfo;
	window.getCargarInfo = getCargarInfo;
	window.setConectado = setConectado;
	window.getConectado = getConectado;
	window.setAltaVelocidad = setAltaVelocidad;
	window.getAltaVelocidad = getAltaVelocidad;
	window.setTSocial = setTSocial;
	window.getTSocial = getTSocial;
 	window.setIdUsuario = setIdUsuario;
	window.getIdUsuario = getIdUsuario;
	window.setIdTelefono = setIdTelefono;
	window.getIdTelefono = getIdTelefono;
	window.setLocalesBuscar = setLocalesBuscar;
	window.getLocalesBuscar = getLocalesBuscar;
	window.setIsBuscar = setIsBuscar;
	window.getIsBuscar = getIsBuscar;
	window.setIsFavorito = setIsFavorito;
	...
	window.setStoresBuscar = setStoresBuscar;
	window.getStoresBuscar = getStoresBuscar;